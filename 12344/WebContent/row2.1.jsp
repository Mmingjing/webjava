...
<title >xiaoning.com.cn</title>
    ...
    <body>
        <center>
            ...
            <div class="section">
                 <form action="row2.jsp" method="post"name="myform"border="0">
               <caption><h3>确认信息：</h3></caption>
                 
                                             专业：<input type="text"><br>
                                             班级:<input name="classname"type="text"maxlength="20"><br>
                                             必修课程数目:<input name=""type="number"maxlength="25"> <br>
                                             选修课程数目:<input type="number"maxlength="25"><br>
